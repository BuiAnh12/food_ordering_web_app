...
const data = {
    ...
    notes: "Cung cấp đúng các dụng cụ ăn",
    items: [
        { name: "Trà Cây Thập Cẩm", quantity: 1, price: 30000 },
        { name: "Đùi gà rán", quantity: 1, price: 45000 }
    ],
    summary: {
        originalPrice: 75000,
        discount: 22500,
            ...
            <div className="w-full px-4 py-2 mt-20 mb-20">
                <div className="w-full p-4 bg-gray-50">
                    <div className="p-2 bg-yellow-100 text-yellow-800 text-sm rounded-md mb-4">
                        Khách ghi chú: <span className="font-semibold">{data.notes}</span>
                    </div>
                    ...
                    <div className="bg-white p-4 rounded-lg shadow-md mb-4">
                        ...
                        <div className="text-sm">
                            <div className="flex justify-between mb-2">
                                ...
                                <span className="text-gray-800 font-medium">{data.summary.originalPrice.toLocaleString()}₫</span>
                            </div>
                            <div className="flex justify-between mb-2">
                            ...
                            <div className="flex justify-between">
                                <span className="text-md font-bold">Tổng tiền quán nhận ({data.items.length} món)</span>
                                <span className="text-md font-bold text-[#fc6011]">{data.summary.total.toLocaleString()}₫</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white p-4 rounded-lg shadow-md">
                        <div className="flex justify-between text-sm mb-2">
                            ...
                            <a href="/" className="text-blue-500 underline">{data.metadata.orderId}</a>
                        </div>
                        <div className="flex justify-between text-sm mb-2">
                        ...
                        <div className="flex justify-between text-sm">
                            ...
                            <span className="text-gray-800">{data.metadata.estimatedPickup}</span>
                        </div>
                    </div>
                    ...
                    <div className="bg-white p-4 rounded-lg shadow-md mt-2">
                        <div className="flex justify-between text-sm mb-2">
                            ...
                            <span className="text-gray-800">{data.status.orderStatus}</span>
                        </div>
                        <div className="flex justify-between text-sm">
                            <span className="text-gray-600">Phương thức thanh toán</span>
                            <span className="text-gray-800">{data.status.paymentMethod}</span>
                        </div>
                    </div>
